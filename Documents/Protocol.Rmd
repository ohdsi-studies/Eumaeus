...
* Exposures: previous viral vaccines including 2017-2018 flu, H1N1pdm flu, Human Papillomavirus (HPV), and Varicella-Zoster. <!-- TODO -->
...
amendments <- readr::read_delim(col_names = TRUE, delim = ";", trim_ws = TRUE, file = "
  ...
  2.0.0;2023-10-05; Investigators; Added new authors; Second EUMAEUS study.
  2.0.0;2023-10-05; Exposure-outcome pairs; TODO COVID vaccines and myocarditis/pericarditis
  2.0.0;2023-10-05; Methods to evaluation; TODO Added concurrent comparator design;  Second EUMAEUS study.
")

# <!-- TODO All all amendments -->
...
<!-- TODO Add two COVID vaccines to `ExposuresOfInterest.csv` file -->
...
### Real-world positive control outcomes

TODO: to state that one outcome identified and labeled for COVID vaccines: myocarditis/pericarditis, will be used as a positive control to evaluate each method’s ability and timeliness to detect an increased association.
