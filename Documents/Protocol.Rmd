...
# NOTE: We lack an abstract. Dani to write once agreed on Aims (see below).
...
# NOTE: not keen on % bias eg average or similar of estimated-true effect size/true effect size for all positive and negative controls, or something similar? it's kind of similar to coverage of course.
