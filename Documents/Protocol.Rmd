...
Typically a single rate is estimated for the entire population, but we will also evaluate stratification on age and sex, allowing the expected rate to be adjusted for the demographics of the vaccinated.
- Propensity-score adjusted contemporary non-user comparator. 
