...
For the concurrent comparator method we define 0 - 7, 1 - 21 and 1 - 28 time-at-risk windows for greater comparability with the literature.
...
For the zoster and HPV vaccines requiring multiple doses, metrics will be computed three times: 
